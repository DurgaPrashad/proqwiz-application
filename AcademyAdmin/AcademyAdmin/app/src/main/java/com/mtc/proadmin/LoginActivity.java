...
import static com.mtc.proadmin.DbQuery.checkPermissions;
import static com.mtc.proadmin.DbQuery.loadData;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            checkPermissions(uid, new com.mtc.proadmin.OnCompleteListener() {
                                @Override
                                public void onSuccess() {

                                    if(DbQuery.authorised)
                                    {
                                        loadData(new com.mtc.proadmin.OnCompleteListener() {
